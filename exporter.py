...
EXPORT_MODELS = [
    {"format": "engine", "half": False, "int8": True, "optimize": True, "save_name": "tensorrt.engine"}]
...
for model_name in tqdm(BASE_MODELS):
    ...
    for model_config in EXPORT_MODELS:
        ...
        model.export(format=model_config["format"], half=model_config["half"], int8=model_config["int8"], simplify=True,
